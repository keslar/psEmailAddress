...
For questions, usage help, or general conversation about the module, please use
[GitHub Discussions](https://github.com/keslar/psEmailAddress/discussions). This
keeps answers searchable and visible to other users who may have the same question.

### GitHub Issues

Issues are for **confirmed bugs** and **feature requests**, not usage questions.
Before opening one:
...
There is no paid support tier, SLA, or guaranteed response time.

## PowerShell Resources

If your question is about PowerShell itself rather than this module, these
resources are a good starting point:

- [PowerShell Documentation](https://learn.microsoft.com/powershell/)
- [PowerShell Community on GitHub](https://github.com/PowerShell/PowerShell/discussions)
